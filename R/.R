...
#==================================================
# 1/ volume_of_blood_mL -> Volume of blood used for DNA
#	 extraction (unit: mililiter)
...
# 4/ DNA_input_concentration_ng_uL -> Concentration of
#	 input DNA (unit: nanogram/microliter)
# 5/ raw.MEAN_BAIT_COVERAGE -> The mean coverage of all
#	 baits in the experiment
# 6/ collapsed.MEAN_BAIT_COVERAGE -> The mean coverage
#	 of all baits in the experiment (collapsed and stitched reads)
...
#==================================================
# Comparison of sequencing depth of cases and control
# cfDNA samples
#==================================================
tmp = qc_metrics %>%
	  filter(Sample_Type=="cfDNA") %>%

...
vioplot(cfdna_frac[cfdna_frac[,3]==1,2], at = 1, add = TRUE, col="white", border = awtools::mpalette[3], rectCol = "black", lineCol = "black", pchMed = 19, colMed = "white")
beeswarm(cfdna_frac[cfdna_frac[,3]==1,2], method="swarm", col=transparent_rgb(awtools::mpalette[3], 205), add=TRUE, pch=19, at=1, cex=1.75, corral="random", corralWidth=.9)
vioplot(cfdna_frac[cfdna_frac[,3]==2,2], at = 2, add = TRUE, col="white", border = awtools::mpalette[2], rectCol = "black", lineCol = "black", pchMed = 19, colMed = "white")
beeswarm(cfdna_frac[cfdna_frac[,3]==2,2], method="swarm", col=transparent_rgb(awtools::mpalette[2], 205), add=TRUE, at=2, pch=19, cex=1.75, corral="random", corralWidth=.8)
vioplot(cfdna_frac[cfdna_frac[,3]==3,2], at = 3, add = TRUE, col="white", border = awtools::mpalette[4], rectCol = "black", lineCol = "black", pchMed = 19, colMed = "white")
beeswarm(cfdna_frac[cfdna_frac[,3]==3,2], method="swarm", col=transparent_rgb(awtools::mpalette[4], 205), add=TRUE, at=3, pch=19, cex=1.75, corral="random", corralWidth=.8)
